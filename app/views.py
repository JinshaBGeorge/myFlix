...
def home():
    ...
    url1 = "http://35.204.195.236/myflix/videos"
    ...
    url2 = "http://35.204.195.236/myflix/categories"
...
def video_page(video):
  ...
  url = 'http://35.204.195.236/myflix/videos?filter={"video.uuid":"'+video+'"}'
  ...
  url2= 'http://35.204.195.236/myflix/videos?filter={"video.category":"'+category+'"}'
